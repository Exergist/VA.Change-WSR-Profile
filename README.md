...
8. Either command is used like any other VA command. However there are two important details that you need to remember:
   ...
   3. Open the Windows Speech Properties window and confirm (from Windows' point of view) that the switch was successful. In other words the profile you activated should now have a checkmark next to its name. 
9. Profit!
